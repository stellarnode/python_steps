...
import daily_rbs_payment_credentials_smartrus as creds
...
subject = 'SMART-RUS Payments from {} to {}'.format(start_formatted, end_formatted)
email_text = text_to_send

message = 'From: {}\nTo: {}\nSubject: {}\n\n{}'.format('Smart-Rus Mailer <' + email + '>',
                                                       dest_email, 
                                                       subject, 
                                                       email_text)
